...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --arch=arm --enable-cross-compile --cross-prefix=arm-linux-androideabi- --enable-gpl --disable-shared --disable-symver --disable-doc --disable-ffplay --enable-ffmpeg --disable-ffprobe --disable-ffserver --disable-avdevice --disable-devices --enable-protocols --enable-parsers --enable-demuxers --disable-demuxer=sbg --enable-libx264 --enable-encoder=libx264 --enable-nonfree --enable-libfdk-aac --enable-decoders --enable-network --enable-swscale --enable-asm --enable-optimizations --enable-asm --enable-swresample --prefix=/root/junz/ffmpeg-2.5/build/ffmpeg/armv7 --extra-cflags='-O3 -Wall -pipe -fpic -fasm   -finline-limit=300 -ffast-math   -fstrict-aliasing -Werror=strict-aliasing   -fmodulo-sched -fmodulo-sched-allow-regmoves   -Wno-psabi -Wa,--noexecstack   -DANDROID -DNDEBUG -march=armv7-a -mthumb -mfpu=vfpv3 -mfloat-abi=softfp -I/root/junz/ffmpeg-2.5/external/include -I/root/junz/ffmpeg-2.5/external/include/x264' --extra-ldflags='-Wl,--fix-cortex-a8 -L/root/junz/ffmpeg-2.5/external/libs/fdk-aac -L/root/junz/ffmpeg-2.5/external/libs/x264'
...
CFLAGS=  -O3 -Wall -pipe -fpic -fasm -finline-limit=300 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -fmodulo-sched -fmodulo-sched-allow-regmoves -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -march=armv7-a -mthumb -mfpu=vfpv3 -mfloat-abi=softfp -I/root/junz/ffmpeg-2.5/external/include -I/root/junz/ffmpeg-2.5/external/include/x264 -march=armv7-a -std=c99 -fomit-frame-pointer -fPIC -mthumb -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -O3 -Wall -pipe -fpic -fasm -finline-limit=300 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -fmodulo-sched -fmodulo-sched-allow-regmoves -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -march=armv7-a -mthumb -mfpu=vfpv3 -mfloat-abi=softfp -I/root/junz/ffmpeg-2.5/external/include -I/root/junz/ffmpeg-2.5/external/include/x264 -march=armv7-a -fPIC -g
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
DOXYGEN=doxygen
LDFLAGS= -Wl,--fix-cortex-a8 -L/root/junz/ffmpeg-2.5/external/libs/fdk-aac -L/root/junz/ffmpeg-2.5/external/libs/x264  -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
